...
public class CuisineDemandeEventController implements Serializable {
    ...
    private CuisineDemandeEvent current;
    ...
    public CuisineDemandeEvent getSelected() {
        if (current == null) {
            current = new CuisineDemandeEvent();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (CuisineDemandeEvent) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CuisineDemandeEventCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CuisineDemandeEventUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CuisineDemandeEventDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class CuisineDemandeEventControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof CuisineDemandeEvent) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CuisineDemandeEvent.class.getName());
            }
        }
