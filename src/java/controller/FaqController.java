...
public class FaqController implements Serializable {
    ...
    @EJB
    private service.FaqFacade ejbFacade;
    ...
    public Faq getFaq(java.lang.Long id) {
    ...
    public static class FaqControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Faq) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Faq.class.getName());
            }
        }
