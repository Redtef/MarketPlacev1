...
public class PlanningController implements Serializable {
    ...
    private PlanningFacade getFacade() {
        return ejbFacade;
    }

    public Planning prepareCreate() {
        selected = new Planning();
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("PlanningCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("PlanningUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("PlanningDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Planning getPlanning(java.lang.Long id) {
        return getFacade().find(id);
    }

    public List<Planning> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Planning> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class PlanningControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Planning) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Planning.class.getName()});
                return null;
            }
        }
