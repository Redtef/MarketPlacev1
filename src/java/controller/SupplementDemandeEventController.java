...
public class SupplementDemandeEventController implements Serializable {
    ...
    private SupplementDemandeEvent current;
    ...
    public SupplementDemandeEvent getSelected() {
        if (current == null) {
            current = new SupplementDemandeEvent();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (SupplementDemandeEvent) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SupplementDemandeEventCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SupplementDemandeEventUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SupplementDemandeEventDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class SupplementDemandeEventControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SupplementDemandeEvent) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + SupplementDemandeEvent.class.getName());
            }
        }
